                ...
                <details className="group relative">
                  <summary className="text-theme flex h-10 w-10 cursor-pointer list-none items-center justify-center rounded-lg transition-all hover:scale-105 hover:bg-gradient-to-br hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-950/50 dark:hover:to-purple-950/50">
                    <div className="relative h-5 w-5">
                      <span className="absolute top-0 left-0 h-0.5 w-5 rounded-full bg-current transition-all duration-300 group-open:translate-y-2 group-open:rotate-45"></span>
                      <span className="absolute top-2 left-0 h-0.5 w-5 rounded-full bg-current transition-all duration-300 group-open:opacity-0"></span>
                      <span className="absolute top-4 left-0 h-0.5 w-5 rounded-full bg-current transition-all duration-300 group-open:-translate-y-2 group-open:-rotate-45"></span>
                    </div>
                  </summary>
                  <div className="animate-in fade-in slide-in-from-top-2 absolute top-12 right-0 z-50 min-w-[200px] rounded-xl border border-gray-200 bg-white/95 shadow-xl backdrop-blur-sm dark:border-gray-700 dark:bg-gray-900/95">
