...
## はじめに
MCPサーバーをざっくり理解するために作ってみたがテーマです。    
...
因みに成果物はこちらです。  
<ExLink url="https://github.com/sori883/mcp-server-blog" />
...
<ExLink url="https://modelcontextprotocol.io/quickstart/user" />
...
## あとがき
MCPサーバーなる名前で小難しそうなイメージですが、実際にはJsonRPCで1ファイルで簡単に作り始められるものなんですね～。  
...
## 参考
<ExLink url="https://modelcontextprotocol.io/docs/concepts/architecture" />
<ExLink url="https://azukiazusa.dev/blog/typescript-mcp-server/" />
