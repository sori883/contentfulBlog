...
因みに成果物はこちらです。  
<ExLink url="https://github.com/sori883/mcp-server-blog" title="sori883/mcp-server-blog" />
...
<ExLink url="https://modelcontextprotocol.io/quickstart/user" title="For Claude Desktop Users" />
...
## 参考
<ExLink url="https://jsr.io/@mizchi/mcp-helper/0.0.4" title="@mizchi/mcp-helper" />
<ExLink url="https://azukiazusa.dev/blog/typescript-mcp-server/" title="TypeScript で MCP サーバーを実装し、Claude Desktop から利用する" />
